...
type PrintableItem = Driver | Vehicle | Employee | Trip | Accident | Vendor | Bill | DemandNote | ComparativeStatement;
type PrintType = 'driver' | 'vehicle' | 'employee' | 'trip' | 'accident' | 'vendor' | 'bill' | 'demand-note' | 'comparative-statement';
