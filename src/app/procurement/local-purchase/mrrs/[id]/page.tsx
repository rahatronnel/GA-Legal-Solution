...
import { ArrowLeft, User, FileText, Download, Printer, Clock, Check, X, Building, CheckCircle, Hourglass, MoreHorizontal, Hash, Truck, Package, Box, MapPin, DollarSign, MessageSquare, Tag } from 'lucide-react';
